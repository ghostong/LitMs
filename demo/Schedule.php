...
//每300秒执行一次非阻塞
//Lit\LitMs\LitMsSchedule::every(300,function(){
//    echo "every 300 second \n";
//},"MyEvent");

//每200秒执行一次阻塞
//Lit\LitMs\LitMsSchedule::loop(200,function(){
...
//每2分钟执行一次
//Lit\LitMs\LitMsSchedule::cron("*/2","*","*","*","*", function (){
//    echo "Cron run ","*/2 ","* ","* ","* ","* ",PHP_EOL;
//},"MyCron1Name");

//每小时第15分执行一次
//Lit\LitMs\LitMsSchedule::cron("15","*","*","*","*", function (){
//    echo "Cron run ","15 ","* ","* ","* ","* ",PHP_EOL;
//},"MyCron2Name");

//每月1日 21时 32-32分每分钟执行
//Lit\LitMs\LitMsSchedule::cron("32-34","21","1","*","*", function (){
